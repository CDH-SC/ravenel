...
?>
<?php if (isset($_GET["search"]) || isset($_GET["options"], $_GET["input"])): ?>
  <div class="container">
      ...
      <div class="col-xs-12">
        ...
        <div class="tab-content">
          <div class="tab-pane fade active in" id="journals">
            <?php $array = array("Thumbnail", "Date", "People", "Location", "Transcript", "Scientific Plant Names", "Common Plant Names", "Title", "Coordinates", "Description"); ?>
            <ul class="list-inline" data-toggle="columns">
              <li>Toggle Columns:</li>

              <?php for ($i = 0; $i < count($array); $i++): ?>
                <li><a href="#remove-column-<?php print $i; ?>" class="<?php print $i < 5 ? "is-visible" : "is-not-visible"; ?>" data-column="<?php print $i; ?>"><?php print $array[$i]; ?></a></li>
              <?php endfor; ?>
            </ul>
          ...
          <div class="tab-pane fade" id="letters" style="position: absolute; display: block; pointer-events: none;">
            <?php $array = array("Thumbnail", "Date", "People", "Title", "Location", "Description", "Scientific Plant Names", "Common Plant Names", "Coordinates", "Transcript"); ?>
            <ul class="list-inline" data-toggle="columns">
              <li>Toggle Columns:</li>
          ...
          <div class="tab-pane fade" id="specimens" style="position: absolute; display: block; pointer-events: none;">
            <?php $array = array("Thumbnail", "Scientific Plant Names", "Date", "Identified By", "Location", "Coordinates", "Habitat", "Collected By", "Cultivation Status"); ?>
            <ul class="list-inline" data-toggle="columns">
              <li>Toggle Columns:</li>
...
<?php else: ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <form class="form-horizontal" action="<?php print ROOT_FOLDER; ?>search" autocomplete="off" enctype="application/x-www-form-urlencoded">
    ...
    <div class="row">
      ...
      <div class="col-sm-6" data-step data-step-title="Advanced Search" data-step-content="Add in some words, take out some other words, maybe include that one word." data-step-placement="top">
        <form class="form-horizontal" id="advancedForm" action="<?php print ROOT_FOLDER; ?>search" autocomplete="off" enctype="application/x-www-form-urlencoded">
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-sm-4 col-sm-spacing" data-step data-step-title="Customized Search Fields" data-step-content="Customize the ability to search within a specific field." data-step-placement="right">
                <select class="form-control" name="options[]">
                  <optgroup label="All">
                    <?php foreach ($optionsAll as $value=>$option): ?>
                      <option value="<?php print $value; ?>"><?php print $option; ?></option>
                    <?php endforeach; ?>
                  </optgroup>

                  <optgroup label="Manuscripts">
                    <?php foreach ($optionsManuscripts as $value=>$option): ?>
                      <option value="<?php print $value; ?>"><?php print $option; ?></option>
                    <?php endforeach; ?>
                  </optgroup>

                  <optgroup label="Specimens">
                    <?php foreach ($optionsSpecimens as $value=>$option): ?>
                      <option value="<?php print $value; ?>"><?php print $option; ?></option>
                    <?php endforeach; ?>
                  </optgroup>
                </select>
