<?php
	...
	//if this page is just ping accessed to send mail, handle that here
...
<?php
	...
	*/
	...
	{
?>
	<link rel="stylesheet" href="<?php print ROOT_FOLDER; ?>css/<?=$class?>">
<?php
	}
...
?>
							<li>
								<a href="<?php print ROOT_FOLDER.($nav === "Home" ? "index" : strtolower($nav)).".php"; ?>"><?=$nav?></a>
							</li>
<?php
	}
?>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li class="divider"></li>
									<li>
										<a href="<?php print ROOT_FOLDER; ?>map.php?type=letters">Correspondence Map</a>
									</li>
									<li class="divider"></li>
									<li>
										<a href="<?php print ROOT_FOLDER; ?>map.php?type=plants">Plant Specimens Map</a>
									</li>
								</ul>
							</li>
							<li>
								<a href="<?php print ROOT_FOLDER; ?>portraits.php">Portraits</a>
							</li>
							<li>
								<a href="<?php print ROOT_FOLDER; ?>fungi.php">Fungi</a>
							</li>
							<li>
								<a href="#" id="search"><i class="fa fa-search" style="font-size: 14px;"></i></a>
							</li>
						</ul>
					</div>
				</nav>
